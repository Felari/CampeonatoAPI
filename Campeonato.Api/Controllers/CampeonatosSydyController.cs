...
namespace Campeonato.Application.Controllers
{
    ...
    public class CampeonatosSydyController : ControllerBase
    {
        ...
        public CampeonatosSydyController(CampeonatoDbContext context)
        {
            _context = context;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<CampeonatoSydyEntity>>> GetCampeonatoSydy()
        {
            return await _context.CampeonatoSydy.ToListAsync();
        }
